...
const Rightmenubar = () => {
  return (
    <div className='flex hidden lg:block flex-col p-5 w-[15%] border-l-2 border-solid border-gray-100 items-center'>
      ...
      <h1 className='text-gray-500 text-lg cursor-pointer m-4 flex justify-between items-center hover:underline'><span className='mr-2'><BsFillChatRightTextFill/></span>Chat with us</h1>
      <h1 className='text-gray-500 text-lg cursor-pointer m-4 flex justify-between items-center hover:underline'><span className='mr-2'><BsFillTelephoneForwardFill/></span>Contact Us</h1>
